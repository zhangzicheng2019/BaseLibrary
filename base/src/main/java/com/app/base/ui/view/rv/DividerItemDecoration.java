...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private boolean isDrawStartLocation;
     ...
     */
    public DividerItemDecoration(Context context, int orientation, boolean isDrawStartLocation) {
        final TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = a.getDrawable(0);
        a.recycle();
        setOrientation(orientation);
        this.isDrawStartLocation = isDrawStartLocation;
    }
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        if(isDrawStartLocation){
            mDivider.setBounds(0, top, mDivider.getIntrinsicWidth(), bottom);
            mDivider.draw(canvas);
        }
