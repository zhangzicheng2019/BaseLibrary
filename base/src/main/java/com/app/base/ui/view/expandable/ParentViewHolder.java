...
public class ParentViewHolder<P extends Parent<C>, C> extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    /**
     * Empowers {@link com.app.base.ui.view.expandable.ExpandableRecyclerAdapter}
     ...
     * {@link com.app.base.ui.view.expandable.ExpandableRecyclerAdapter}.
     *
    ...
    protected void expandView() {
        ...
        if (mParentViewHolderExpandCollapseListener != null) {
            mParentViewHolderExpandCollapseListener.onParentExpanded(getAdapterPosition() - mExpandableAdapter.getHeaderViewCount());
        }
    }
    ...
    protected void collapseView() {
        ...
        System.out.println("getAdapterPosition()" + getAdapterPosition());
        if (mParentViewHolderExpandCollapseListener != null) {
            mParentViewHolderExpandCollapseListener.onParentCollapsed(getAdapterPosition() - mExpandableAdapter.getHeaderViewCount());
        }
    }
}
